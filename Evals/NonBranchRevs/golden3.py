...
EMBEDDINGS_MODEL = "text-embedding-3-large" # "text-embedding-3-small" # "text-embedding-3-large"
DATA_PATH = "data/"
...
def langsmith_create_evaluations(complete_df):
    ...
    try:
        ...
        evaluation_run = client.run_evaluation(
            ...
            evaluation_name=f"OT RAG Evaluation",
            dataset_name=dataset_name,
...
def main():
    ...
    with open("evaluation_results.txt", "a") as f:
        f.write(f"'Model Used': '{MODEL}' Embeddings Model Used': '{EMBEDDINGS_MODEL}' 'RESULTS':{evaluation_results}\n")
